...
/*   Updated: 2022/12/12 14:29:01 by raruiz-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_image_path(t_map *map)
{
	if (open_image("./assets/player.xpm") == false
		|| open_image("./assets/player1.xpm") == false
		|| open_image("./assets/player2.xpm") == false
		|| open_image("./assets/player3.xpm") == false
		...
		|| open_image("./assets/enemy.xpm") == false)
	{
...
bool	assets_to_images(t_map *map)
{
	...
	map->img_z = mlx_xpm_file_to_image(map->mlx, "./assets/floor.xpm",
			&map->img_width, &map->img_height);
	assets_to_images_ctd(map);
	return (true);
}

bool	assets_to_images_ctd(t_map *map)
{
	map->img_x = mlx_xpm_file_to_image(map->mlx, "./assets/enemy.xpm",
			&map->img_width, &map->img_height);
	map->img_p1 = mlx_xpm_file_to_image(map->mlx, "./assets/player1.xpm",
			&map->img_width, &map->img_height);
	map->img_p2 = mlx_xpm_file_to_image(map->mlx, "./assets/player2.xpm",
			&map->img_width, &map->img_height);
	map->img_p3 = mlx_xpm_file_to_image(map->mlx, "./assets/player3.xpm",
			&map->img_width, &map->img_height);
	if (map->img_p == NULL || map->img_c == NULL || map->img_e == NULL
		|| map->img_w == NULL || map->img_z == NULL || map->img_x == NULL
		|| map->img_p1 == NULL || map->img_p2 == NULL || map->img_p3 == NULL)
		return (false);
	return (true);
}
...
{
	if (asset == 'P')
		mlx_put_image_to_window(map->mlx, map->win, map->img_p, map->x * 64,
			map->y * 64);
	else if (asset == 'C')
		mlx_put_image_to_window(map->mlx, map->win, map->img_c, map->x * 64,
			map->y * 64);
	else if (asset == 'E')
		mlx_put_image_to_window(map->mlx, map->win, map->img_e, map->x * 64,
			map->y * 64);
	else if (asset == '1')
		mlx_put_image_to_window(map->mlx, map->win, map->img_w, map->x * 64,
			map->y * 64);
	else if (asset == '0')
		mlx_put_image_to_window(map->mlx, map->win, map->img_z, map->x * 64,
			map->y * 64);
	else if (asset == 'X')
		mlx_put_image_to_window(map->mlx, map->win, map->img_x, map->x * 64,
			map->y * 64);
	return (0);
}
